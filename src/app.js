...
import carLikesRouter from './routers/carLikes.router.js';
import carCollectionLikesRouter from './routers/carCollectionLikes.router.js';
...
app.use('/api/carLikes', carLikesRouter);
app.use('/api/carCollectionLikes', carCollectionLikesRouter);
