...
const schema = new mongoose.Schema({
    ...
    editionType : { type: String, enum: ['standard', 'limited', 'chase', 'treasure_hunt', 'super_treasure_hunt', 'error'], default: 'standard'},
    editionLimitedTo : {type: Number, default : null},
    editionChaseType : {type : String, default : null},
    editionIsVerified : {type : Boolean, default: false},
    editionNotes : {type: String, default: null},
